...
**Назначение:** REST API сервис для получения статистики, отчетов и метрик производительности системы.
...
- API endpoints: 6 основных endpoints
